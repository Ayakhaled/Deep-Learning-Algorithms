...
w1 = theano.shared(value = np.random.rand(no_of_features, no_of_hidden_NL1)* 0.1, name = 'Layer1 weights') 
w2 = theano.shared(value = np.random.rand(no_of_hidden_NL1, no_of_hidden_NL2)* 0.1, name = 'Layer2 weights') 
